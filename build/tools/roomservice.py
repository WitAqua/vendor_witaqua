...
custom_dependencies = "witaqua.dependencies"
org_manifest = "WitAqua-Devices"  # leave empty if org is provided in manifest
org_display = "WitAqua-Devices"  # needed for displaying
...
def main():
    ...
    for repository in repositories:
        ...
        adding = [{'repository': "WitAqua-Devices/" + repo_name, 'target_path': repo_path}]
