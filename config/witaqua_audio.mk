...
ALARM_PATH := vendor/witaqua/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/witaqua/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/witaqua/prebuilt/common/media/audio/ringtones
